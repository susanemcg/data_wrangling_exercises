...
# biz_names = pd.unique(got_2M['BorrowerNameFingerprint'])
#
...
# second_round_max = pd.merge(full_data, biz_names_df, on='BorrowerNameFingerprint')
#
...
# print(total_funds)
#
# # finally, let's plot *all* the
#
# # we're going to make a few plots
...
# # use tuples to access the different subplots
...
# example is Copper River Seafoods in zip 99501-2759
